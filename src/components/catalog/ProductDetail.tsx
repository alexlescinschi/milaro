...
const products: Record<string, Product> = {
  ...
  'avenue': {
    ...
    price: 'ab CHF 13',
    variants: [
      { name: 'Weiss Matt', color: '#f0f0ec', images: ['/images/portfolio/f44c267d46b5a028716a8cbc8fa6299b.jpg'] },
      { name: 'Grau Hochglanz', color: '#808080', images: ['/images/portfolio/f44c267d46b5a028716a8cbc8fa6299b.jpg'] },
  ...
  'nicolle-thermoplast': {
    ...
    price: 'ab CHF 10',
    variants: [
      { name: 'Creme', color: '#f5f0e0', images: ['/images/portfolio/148a39bc7b3a09b50699865854c59f62.jpg'] },
      { name: 'Weiss', color: '#fafafa', images: ['/images/portfolio/148a39bc7b3a09b50699865854c59f62.jpg'] },
      { name: 'Grau', color: '#999999', images: ['/images/portfolio/148a39bc7b3a09b50699865854c59f62.jpg'] },
      { name: 'Beige', color: '#dcc8a0', images: ['/images/portfolio/148a39bc7b3a09b50699865854c59f62.jpg'] },
      { name: 'Hellblau', color: '#a3c4dc', images: ['/images/portfolio/148a39bc7b3a09b50699865854c59f62.jpg'] },
    ],
    specs: [
  ...
  'teramo': {
    ...
    price: 'ab CHF 13',
    variants: [
      { name: 'Dunkle Ulme', color: '#5a4535', images: ['/images/portfolio/c454ea964d6cbcecc3f82ca0dbc325b7.jpg'] },
      { name: 'Perlgrau', color: '#c8c8c0', images: ['/images/portfolio/5051d316742def83f7f0668243279072.jpg'] },
      { name: 'Natur-Eiche Premier', color: '#b8956e', images: ['/images/portfolio/dcb21a1a494456ebb329e99d2589ea05.jpg'] },
      { name: 'Grau-Blau', color: '#8aa0b4', images: ['/images/portfolio/c2da511f7809e310ec0b9b2ae303bf6a.jpg'] },
      { name: 'Weisse Esche', color: '#ede8e0', images: ['/images/portfolio/ad2a8635b9208fe4debd2da58f437846.jpg'] },
    ],
    specs: [
