...
const similarProducts = [
  { name: 'Grafis', slug: 'grafis', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files/07pxOyAzMM8LAKQhj_P1p1s.jpg' },
  { name: 'Granby', slug: 'granby', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0cZ3AVTlSyxPUwLgW_fAZRl.jpg' },
  { name: 'Budbin', slug: 'budbin', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0jifM8SdyZJQgxzHv_flxWI.jpg' },
  { name: 'Kolaria', slug: 'kolaria', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0kesx1Y2Pt92wkDDx_04Vkl.jpg' },
  { name: 'Roshedu', slug: 'roshedu', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/097K8FXmtcZoVqJVy_lu4a1.jpg' },
  { name: 'Brix', slug: 'brix', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0q9jxltANXHL3RmIm_2b9zJ.jpg' },
  { name: 'Sadbury', slug: 'sadbury', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/05iefZ2FsYxLSnvb3_z5ytb.jpg' },
  { name: 'Tavira', slug: 'tavira', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/04BaGWDW2glkI84IO_Yjrjl.jpg' },
  { name: 'Richmond', slug: 'richmond', cat: 'kuechen', label: 'Küche', img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0LSLx8yb5i198HrrA_hY4iv.jpg' },
]
...
const products: Record<string, Product> = {
  ...
  'teramo': {
    ...
    features: [
      ...
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/e5f/e5fb567dbb7b8cfe254c2491d9beffa3/cde69a9a547d6d5042df6fcacef4b1d6.jpg', icon: '▦', title: 'Europäischer Verschleissschutz', text: 'Thermoplast — der Massstab an Beständigkeit! Verblasst nicht in der Sonne, widersteht Feuchtigkeit im Bereich von Herd und Spüle.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/6f5/6f514167006e5573934901ef9d58c121/20369ce9489ed76eb476678ed3a8f2a1.jpg', icon: '▯', title: 'Schutz vor Fett und Russ', text: 'Die Beschichtung stösst hartnäckige Verschmutzungen ab. In wenigen Sekunden sauber — ohne Aufwand, jeden Tag.' },
  ...
  'vector': {
    ...
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/e01/e019af3c0e6926865411bad0a14d707a/4d6c6784b17e3bafbadd7530f1704127.jpg', icon: '◇', title: 'Vandal-sichere Beständigkeit', text: '0,6 mm Kunststoff — Panzer gegen Absplitterungen, Kratzer, heisses Geschirr und Haushaltschemikalien.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/42f/42f1a4066abbd348188be3c9566638ce/c51d3477904f8f44dc7bc410e9bf7e49.jpg', icon: '▦', title: 'Schmutz haftet nicht', text: 'Hochglanzoberfläche stösst Fett und Saucen ab. Ein feuchtes Tuch genügt für die tägliche Pflege — ohne Chemikalien.' },
  ...
  'antro-stone': {
    ...
    features: [
      ...
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/ea0/ea0baeb820795a2cc88c4483e888d911/73f59625796e5b93fc897dbbfdfc55f7.jpg', icon: '▦', title: 'Pflege ohne Aufwand', text: 'Schutzimprägnierung stösst Schmutz zuverlässig ab. Mit einem feuchten Schwamm problemlos zu reinigen — kein Sonderaufwand nötig.' },
  ...
  'milaro-garden': {
    ...
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/956/95660f4a8e96381acef3d8eb6db6882f/dcd8e438154a09bf051818beab3324c7.jpg', icon: '◇', title: 'Umfangreiche Planungsmöglichkeiten', text: '14 offene und geschlossene Module sowie Kochinseln zur Auswahl — grenzenlose Gestaltungsfreiheit für jeden Aussenbereich.' },
      ...
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/1fb/1fb771fa52be1bf6fdf9ff309c80c7c2/4cc3d849a55280bfc6327bb1575dd094.jpg', icon: '◈', title: 'Outdoor-Materialien', text: 'Materialien und Beschichtungen eigens für den Ausseneinsatz entwickelt — robust, pflegeleicht und langlebig unter freiem Himmel.' },
    ],
  },
  'vector-touch': {
    name: 'Vector Touch',
  ...
  'integrato': {
    ...
    features: [
      ...
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0e4/0e4d6c501797589aefdb0c97bd520e6d/36344037b995985766eeceef83ce2416.jpg', icon: '▦', title: 'Geräuschloses Schliessen', text: 'Integrierte Dämpfer sorgen für sanftes, leises Schliessen — kein lautes Zuschlagen, kein Lärm, auch spät abends.' },
      ...
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/8a3/8a38b26082c0684767a031b045e5e495/3dee7a29ee0c47aa9e279a10ff50b478.jpg', icon: '◈', title: 'Robuste Emaille auf 22 mm MDF', text: 'Fronten aus 22 mm MDF mit Emaillebeschichtung — aussergewöhnliche Belastbarkeit und langfristige Schönheit im Küchenalltag.' },
    ],
  },
  'wood-dekor-email': {
  ...
  'tokyo-glanz': {
    ...
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/f80/f807968a848ff69c3b1586fc5a08ae39/82128da6551c91c84cbb51e5d417a8dd.jpg', icon: '◇', title: 'Hochglanz-Optik', text: 'Spiegelnde Fronten reflektieren das Licht und lassen die Küche grösser, heller und moderner wirken — ideal für kleinere Räume.' },
      ...
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/3f8/3f8115b27b51cadc591478e94a3bc8f5/78e7482b94a2107ea5db1e1f0ec879ea.jpg', icon: '◈', title: 'Grosse Farbauswahl', text: 'Von reinweissem Hochglanz bis zu tiefem Anthrazit — wählen Sie den Ton, der zu Ihrem Zuhause passt.' },
    ],
  },
  'nicolle-cabinet': {
    ...
    price: 'ab CHF 12',
    variants: [
      { name: 'Weiss Matt', color: '#f0eeeb', images: ['https://upload-bxp-mfm.marya.ru/iblock/35e/35e7ac9ae63a2a1b811264fce71935f5/cbee8d4dad621234d3f54ea4a10d0607.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/62e/62ee77782535dc37b2f988802262588d/dcb38934e0b6fa288a1c17a888d8ec7f.jpg'] },
      { name: 'Cashmere Beige', color: '#d4c8b8', images: ['https://upload-bxp-mfm.marya.ru/iblock/eb1/eb1b0f57b97e224234407c335d8cfb22/a6bc17bf00b5cd9598b633be4b50f2dd.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/d4b/d4b61767bb7213b03b0afb7c23362b6a/b00f685e4aaf8e201a0b752d30a3af37.jpg'] },
    ],
    specs: [
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/35e/35e7ac9ae63a2a1b811264fce71935f5/cbee8d4dad621234d3f54ea4a10d0607.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/35e/35e7ac9ae63a2a1b811264fce71935f5/cbee8d4dad621234d3f54ea4a10d0607.jpg', icon: '◇', title: 'Zeitloses Design', text: 'Klare Linien und hochwertige Oberflächen — Nicolle passt sich jedem Einrichtungsstil an.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/62e/62ee77782535dc37b2f988802262588d/dcb38934e0b6fa288a1c17a888d8ec7f.jpg', icon: '▦', title: 'Durchdachte Innenaufteilung', text: 'Kleiderstangen, Einlegeböden und Schubladen lassen sich individuell kombinieren.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/eb1/eb1b0f57b97e224234407c335d8cfb22/a6bc17bf00b5cd9598b633be4b50f2dd.jpg', icon: '▯', title: 'Präzise Scharniere', text: 'Softclose-Scharniere sorgen für leises, sanftes Schliessen — langlebig und wartungsfrei.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/d4b/d4b61767bb7213b03b0afb7c23362b6a/b00f685e4aaf8e201a0b752d30a3af37.jpg', icon: '◈', title: 'Massgefertigt', text: 'Jeder Schrank wird nach Ihren Raummassen produziert — kein Zentimeter verschwendet.' },
    ],
  },
  'mixal-cabinet': {
    name: 'Mixal Schrank',
    ...
    price: 'ab CHF 10',
    variants: [
      { name: 'Eiche Natur', color: '#c8a870', images: ['https://upload-bxp-mfm.marya.ru/iblock/f22/f22a1c12d1017be7df6408851d3a2f90/7a58d65e9c6a2fb00d2baba817e3e4ab.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/0cc/0cc130a78014ca9854ac7c1945402626/c8404b22e082c785b272c0c11e93ba55.jpg'] },
      { name: 'Wenge Dunkel', color: '#3a2515', images: ['https://upload-bxp-mfm.marya.ru/iblock/903/903bac3453a8f94056c60897d51c523f/a239dadbbaad5628b4c88a7ef17bfd3d.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/da4/da49e414f9673532a90775fc112dc37f/838d28dd2530824b20527b8669e2d750.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/f22/f22a1c12d1017be7df6408851d3a2f90/7a58d65e9c6a2fb00d2baba817e3e4ab.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/f22/f22a1c12d1017be7df6408851d3a2f90/7a58d65e9c6a2fb00d2baba817e3e4ab.jpg', icon: '◇', title: 'Natürliche Materialien', text: 'Echte Holzdekore bringen Wärme und Charakter in jeden Raum.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0cc/0cc130a78014ca9854ac7c1945402626/c8404b22e082c785b272c0c11e93ba55.jpg', icon: '▦', title: 'Maximaler Stauraum', text: 'Intelligente Innenaufteilung mit Hängebereich, Schubladen und Fächern.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/903/903bac3453a8f94056c60897d51c523f/a239dadbbaad5628b4c88a7ef17bfd3d.jpg', icon: '▯', title: 'Langlebige Oberfläche', text: 'Kratzfeste Beschichtung — bleibt jahrelang schön und pflegeleicht.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/da4/da49e414f9673532a90775fc112dc37f/838d28dd2530824b20527b8669e2d750.jpg', icon: '◈', title: 'Flexible Breiten', text: 'Erhältlich in verschiedenen Breiten — passt sich jedem Raumgrundriss an.' },
    ],
  },
  'spark-cabinet': {
    name: 'Spark Schrank',
    ...
    price: 'ab CHF 13',
    variants: [
      { name: 'Graphit Struktur', color: '#505050', images: ['https://upload-bxp-mfm.marya.ru/iblock/ec4/ec4c9661d3d8fe59d114ff1b49929695/ea7b176a2eb1e8b6041d418a6097c8d9.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/f98/f98ea0d34d50b29474f9ceb127940cc9/76c92d48046820a4a3a0e186eb80c2e1.jpg'] },
      { name: 'Sandbeige Matt', color: '#d0c0a0', images: ['https://upload-bxp-mfm.marya.ru/iblock/c95/c9515a77c371c38258c8f6428dfb8ccb/54ccddb70156707b6730ac61f03569e3.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/d38/d380e0a12b1c5a97fb16d6d897582e97/4198920705b5069067c6290eb103b85d.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/ec4/ec4c9661d3d8fe59d114ff1b49929695/ea7b176a2eb1e8b6041d418a6097c8d9.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/ec4/ec4c9661d3d8fe59d114ff1b49929695/ea7b176a2eb1e8b6041d418a6097c8d9.jpg', icon: '◇', title: 'Strukturierte Fronten', text: 'Taktile Oberflächen erzeugen Tiefe und Charakter — modern und zeitlos zugleich.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/f98/f98ea0d34d50b29474f9ceb127940cc9/76c92d48046820a4a3a0e186eb80c2e1.jpg', icon: '▦', title: 'Robuste Konstruktion', text: 'Massiver Korpus aus feuchtigkeitsbeständigem Material — jahrelang stabil.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/c95/c9515a77c371c38258c8f6428dfb8ccb/54ccddb70156707b6730ac61f03569e3.jpg', icon: '▯', title: 'Grosszügiger Stauraum', text: 'Breite Innenfächer und Hängebereiche für maximale Ordnung.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/d38/d380e0a12b1c5a97fb16d6d897582e97/4198920705b5069067c6290eb103b85d.jpg', icon: '◈', title: 'Individuelle Konfiguration', text: 'Höhe, Breite und Innenaufteilung werden nach Ihren Wünschen gefertigt.' },
    ],
  },
  'teramo-cabinet': {
    name: 'Teramo Schrank',
    ...
    price: 'ab CHF 14',
    variants: [
      { name: 'Weiss Seidenmatt', color: '#efefed', images: ['https://upload-bxp-mfm.marya.ru/iblock/3ce/3cea6f69c098ae8f56d9a2f5521259b0/e11811d006c22cffa32eb3d3738c3b2f.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/131/1313fe2776e8ffaf39cd0eeeeeaf1683/0eefa72016688da9c04c58798c059e81.jpg'] },
      { name: 'Taubengrau NCS', color: '#9898a0', images: ['https://upload-bxp-mfm.marya.ru/iblock/4fd/4fd21ccfa2409d93cab9b6e1c016eb62/26c39bf4cc7d0fb559f9122e3eea180c.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/7d7/7d774e632a82b89622d92455b4868da8/9f5c98a6a2e0e7168a578af84b0c463c.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
      { label: 'Material', value: 'MDF lackiert' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/3ce/3cea6f69c098ae8f56d9a2f5521259b0/e11811d006c22cffa32eb3d3738c3b2f.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/3ce/3cea6f69c098ae8f56d9a2f5521259b0/e11811d006c22cffa32eb3d3738c3b2f.jpg', icon: '◇', title: 'Rahmendesign', text: 'Profilierte Rahmen geben dem Schrank eine elegante Tiefenwirkung.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/131/1313fe2776e8ffaf39cd0eeeeeaf1683/0eefa72016688da9c04c58798c059e81.jpg', icon: '▦', title: 'Aluminium-Griffleisten', text: 'Feine Alu-Griffleisten als stilvolles Element und ergonomischer Griff zugleich.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/4fd/4fd21ccfa2409d93cab9b6e1c016eb62/26c39bf4cc7d0fb559f9122e3eea180c.jpg', icon: '▯', title: 'Mattes Finish', text: 'Samtig-matte Oberfläche — fingerabdruckresistent und immer edel.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/7d7/7d774e632a82b89622d92455b4868da8/9f5c98a6a2e0e7168a578af84b0c463c.jpg', icon: '◈', title: 'Massgefertigt', text: 'Jede Einheit wird auf Ihren Raum abgestimmt — vom Boden bis zur Decke.' },
    ],
  },
  'mix-wardrobe': {
    ...
    price: 'ab CHF 11',
    variants: [
      { name: 'Glas / Weiss', color: '#e8eef0', images: ['https://upload-bxp-mfm.marya.ru/iblock/351/3512c391d7da61536438733d68edf959/e9db682281519675cf3c0d4813486a64.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/a58/a589481c64915f0c77aae6b130f9ef28/7842363bc9dbe4f13d74ca85df3d5495.jpg'] },
      { name: 'Spiegel / Eiche', color: '#c0a870', images: ['https://upload-bxp-mfm.marya.ru/iblock/fa2/fa2216fae37c91ecea167dc3f1989f33/9370a66ecde080de49a047caa70a7b52.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/3e3/3e37d4977dc7a4a4c2df4fee603f8272/7f05c377f639d49f663c2f12718821f0.jpg'] },
    ],
    specs: [
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/351/3512c391d7da61536438733d68edf959/e9db682281519675cf3c0d4813486a64.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/351/3512c391d7da61536438733d68edf959/e9db682281519675cf3c0d4813486a64.jpg', icon: '◇', title: 'Platzsparend', text: 'Schiebetüren öffnen nach innen — kein Schwenkraum nötig, ideal für enge Räume.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/a58/a589481c64915f0c77aae6b130f9ef28/7842363bc9dbe4f13d74ca85df3d5495.jpg', icon: '▦', title: 'Freie Frontgestaltung', text: 'Kombinieren Sie Glas, Spiegel und Holzdekor nach Ihrem Geschmack.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/fa2/fa2216fae37c91ecea167dc3f1989f33/9370a66ecde080de49a047caa70a7b52.jpg', icon: '▯', title: 'Lautloses Gleitsystem', text: 'Hochwertige Aluminiumschienen für sanftes, geräuschloses Öffnen und Schliessen.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/3e3/3e37d4977dc7a4a4c2df4fee603f8272/7f05c377f639d49f663c2f12718821f0.jpg', icon: '◈', title: 'Vom Boden bis zur Decke', text: 'Raumhohe Ausführung maximiert den Stauraum und wirkt architektonisch wertvoll.' },
    ],
  },
  'nicolle-wardrobe': {
    ...
    price: 'ab CHF 13',
    variants: [
      { name: 'Mattglas Weiss', color: '#eaece8', images: ['https://upload-bxp-mfm.marya.ru/iblock/583/58326e90edf1f245c991db83d3f287b3/c8e9ae7ad78b5f717798a61bd224c5ee.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/a3e/a3eb5ee282dd2feabb85f459d652fd37/9870f10e4e0da083ba5641e341b2ffae.jpg'] },
      { name: 'Spiegel Grau', color: '#b0b0b8', images: ['https://upload-bxp-mfm.marya.ru/iblock/197/197b17202cca6e0a292421b24018e50a/311f41f7f34869f12afdfab06c855ba4.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/8df/8df14f1a57b88c5bf55cb8ed968303e1/12b17a0fe961c3cb047f5fae71b4c43c.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Schiebetürenschrank' },
      { label: 'Türen', value: 'Glas / Spiegel / Dekor' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/583/58326e90edf1f245c991db83d3f287b3/c8e9ae7ad78b5f717798a61bd224c5ee.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/583/58326e90edf1f245c991db83d3f287b3/c8e9ae7ad78b5f717798a61bd224c5ee.jpg', icon: '◇', title: 'Elegante Frontpaneele', text: 'Feine Rahmenprofile und edle Glasflächen verleihen dem Schrank Luxuscharakter.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/a3e/a3eb5ee282dd2feabb85f459d652fd37/9870f10e4e0da083ba5641e341b2ffae.jpg', icon: '▦', title: 'Spiegelfront-Option', text: 'Der integrierte Spiegel spart Platz und lässt den Raum grösser wirken.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/197/197b17202cca6e0a292421b24018e50a/311f41f7f34869f12afdfab06c855ba4.jpg', icon: '▯', title: 'Innenbeleuchtung möglich', text: 'LED-Streifen im Innern machen das Finden von Kleidung zum Erlebnis.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/8df/8df14f1a57b88c5bf55cb8ed968303e1/12b17a0fe961c3cb047f5fae71b4c43c.jpg', icon: '◈', title: 'Individuelle Inneneinteilung', text: 'Hängestangen, Schubladen, Schuhfächer — alles nach Ihren Bedürfnissen.' },
    ],
  },
  'nova-wardrobe': {
    ...
    price: 'ab CHF 12',
    variants: [
      { name: 'Weiss Hochglanz', color: '#f2f0ee', images: ['https://upload-bxp-mfm.marya.ru/iblock/d71/d7187386f4808db148b182dca73bc079/1c548a5e617fac9cecb9eeeb82918ed3.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/e95/e95cb8a48a3247b164212e2a76ed6be9/18ae86c821167259f84396ce9b60eb96.jpg'] },
      { name: 'Anthrazit Matt', color: '#484848', images: ['https://upload-bxp-mfm.marya.ru/iblock/9d3/9d3882904490d1a2f8dcc8b46aac5895/cda08d2f89a7557783116abc800ba529.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/dae/dae1a7908e404524f1c5e3c8a1ba8349/f1733d50f02ed5408865f28a42a7065f.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Schiebetürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/d71/d7187386f4808db148b182dca73bc079/1c548a5e617fac9cecb9eeeb82918ed3.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/d71/d7187386f4808db148b182dca73bc079/1c548a5e617fac9cecb9eeeb82918ed3.jpg', icon: '◇', title: 'Rahmenlose Fronten', text: 'Kein sichtbarer Rahmen — die Fronten verschmelzen mit der Wand.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/e95/e95cb8a48a3247b164212e2a76ed6be9/18ae86c821167259f84396ce9b60eb96.jpg', icon: '▦', title: 'Bündige Oberfläche', text: 'Alle Fronten auf einer Ebene — kein Vorsprung, keine Kante, pure Form.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/9d3/9d3882904490d1a2f8dcc8b46aac5895/cda08d2f89a7557783116abc800ba529.jpg', icon: '▯', title: 'Unsichtbares Gleitsystem', text: 'Die Schiene ist im Deckenbereich verborgen — kein sichtbares Schienenprofil.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/dae/dae1a7908e404524f1c5e3c8a1ba8349/f1733d50f02ed5408865f28a42a7065f.jpg', icon: '◈', title: 'Beliebige Raumhöhe', text: 'Passt sich jeder Raumhöhe an — vom Standard bis zum Loft.' },
    ],
  },
  'spark-wardrobe': {
    ...
    price: 'ab CHF 14',
    variants: [
      { name: 'Graphit Struktur', color: '#545454', images: ['https://upload-bxp-mfm.marya.ru/iblock/474/47457e1c3b5be6e02e4838cba9d21569/991153059e0204f19d1a6e44471e7691.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/ccd/ccd47944f7513c32690e9a34969e430d/9af035a18ef5a6562cb5274cc15f7669.jpg'] },
      { name: 'Sand Matt', color: '#d0c4a8', images: ['https://upload-bxp-mfm.marya.ru/iblock/d46/d4605ad1a18483e5763ca5a1d863c7e2/9aa7dd6c49631db3b8558fe344ad08b6.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/077/077d25ae29a0a1d6b26646b1ed6055a3/b38e24412ca113fe5b5620ef772bb4c3.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Schiebetürenschrank' },
      { label: 'Material', value: 'MDF strukturiert' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/474/47457e1c3b5be6e02e4838cba9d21569/991153059e0204f19d1a6e44471e7691.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/474/47457e1c3b5be6e02e4838cba9d21569/991153059e0204f19d1a6e44471e7691.jpg', icon: '◇', title: 'Strukturierte Paneele', text: 'Taktile Oberflächen setzen spannende Kontraste zur glatten Wand.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/ccd/ccd47944f7513c32690e9a34969e430d/9af035a18ef5a6562cb5274cc15f7669.jpg', icon: '▦', title: 'Mix aus Materialien', text: 'Kombinieren Sie Struktur mit Spiegel oder Glas für individuelle Akzente.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/d46/d4605ad1a18483e5763ca5a1d863c7e2/9aa7dd6c49631db3b8558fe344ad08b6.jpg', icon: '▯', title: 'Raumhoch montierbar', text: 'Vom Boden bis zur Decke für maximalen Stauraum und architektonische Wirkung.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/077/077d25ae29a0a1d6b26646b1ed6055a3/b38e24412ca113fe5b5620ef772bb4c3.jpg', icon: '◈', title: 'Robuste Konstruktion', text: 'Stabile Gleiter und Doppelschienen für jahrelangen reibungslosen Betrieb.' },
    ],
  },
  'top-line-wardrobe': {
    ...
    price: 'ab CHF 16',
    variants: [
      { name: 'Alu / Glas Klar', color: '#d0d8e0', images: ['https://upload-bxp-mfm.marya.ru/iblock/25c/25c53ba6daaefd8e3528accee7a9b61c/ae2fba7b9993e49687b3175b74a831e7.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/0cc/0cc130a78014ca9854ac7c1945402626/c8404b22e082c785b272c0c11e93ba55.jpg'] },
      { name: 'Alu / Eiche Dekor', color: '#b89860', images: ['https://upload-bxp-mfm.marya.ru/iblock/903/903bac3453a8f94056c60897d51c523f/a239dadbbaad5628b4c88a7ef17bfd3d.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/da4/da49e414f9673532a90775fc112dc37f/838d28dd2530824b20527b8669e2d750.jpg'] },
    ],
    specs: [
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/25c/25c53ba6daaefd8e3528accee7a9b61c/ae2fba7b9993e49687b3175b74a831e7.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/25c/25c53ba6daaefd8e3528accee7a9b61c/ae2fba7b9993e49687b3175b74a831e7.jpg', icon: '◇', title: 'Heavy-Duty Aluminiumprofil', text: 'Breite, stabile Profile für Türen bis 80 kg — solide wie ein Hotelschrank.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0cc/0cc130a78014ca9854ac7c1945402626/c8404b22e082c785b272c0c11e93ba55.jpg', icon: '▦', title: 'Integrierter Soft-Stop', text: 'Die Tür verlangsamt sich automatisch kurz vor dem Anschlag — kein Knall, kein Verschleiss.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/903/903bac3453a8f94056c60897d51c523f/a239dadbbaad5628b4c88a7ef17bfd3d.jpg', icon: '▯', title: 'Freie Füllauswahl', text: 'Glas, Spiegel, Holzdekor, Leder-Optik — nahezu unbegrenzte Kombinationsmöglichkeiten.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/da4/da49e414f9673532a90775fc112dc37f/838d28dd2530824b20527b8669e2d750.jpg', icon: '◈', title: 'Bis 3,5 m Breite', text: 'Auch grosse Wandöffnungen werden vollflächig abgedeckt — kein Pfeiler bleibt ungenutzt.' },
    ],
  },
  'jazz-wardrobe': {
    ...
    price: 'ab CHF 13',
    variants: [
      { name: 'Weiss Matt', color: '#ededea', images: ['https://upload-bxp-mfm.marya.ru/iblock/203/203b523ee26a4ea66f89ec8b45a259e1/1062a76067b8b7c807f8c0c061c60868.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/53f/53fca48a8348e2ea06d3f291e82847f0/7e4a6a62f27218efa6914c5871d3f1a6.jpg'] },
      { name: 'Graphit NCS', color: '#505058', images: ['https://upload-bxp-mfm.marya.ru/iblock/117/117c9c81c308f24d1e6a445cf8638c0b/15376acb0a552a333d2c49fe67fe899c.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/7f6/7f6e8f5f1d091361bb53a1e2c5a54997/a09ca380e3448d02096f5191f5235335.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Schiebetürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/203/203b523ee26a4ea66f89ec8b45a259e1/1062a76067b8b7c807f8c0c061c60868.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/203/203b523ee26a4ea66f89ec8b45a259e1/1062a76067b8b7c807f8c0c061c60868.jpg', icon: '◇', title: 'Jazz-Ästhetik', text: 'Klare Horizontallinien, flächenbündige Fronten — charakteristisch für die Jazz-Serie.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/53f/53fca48a8348e2ea06d3f291e82847f0/7e4a6a62f27218efa6914c5871d3f1a6.jpg', icon: '▦', title: 'Mattes Finish', text: 'Fingerabdruckresistente, samtig-matte Oberfläche für ein immer gepflegtes Erscheinungsbild.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/117/117c9c81c308f24d1e6a445cf8638c0b/15376acb0a552a333d2c49fe67fe899c.jpg', icon: '▯', title: 'Flexible Innenaufteilung', text: 'Hängebereiche, Schubladen, Schuhregale — individuell konfigurierbar.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/7f6/7f6e8f5f1d091361bb53a1e2c5a54997/a09ca380e3448d02096f5191f5235335.jpg', icon: '◈', title: 'Leises Gleitsystem', text: 'Hochwertige Aluminiumschienen für sanftes, geräuschloses Öffnen und Schliessen.' },
    ],
  },
  'mix-cabinet': {
    name: 'Mix 22 Schrank',
    ...
    price: 'ab CHF 10',
    variants: [
      { name: 'Weiss / Eiche', color: '#d8c89a', images: ['https://upload-bxp-mfm.marya.ru/iblock/e78/e782f119c345bb9b1d6b4c72e63aebcb/9d66a403367d58e107dc6f0dad79e040.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/0a3/0a362dee5784b900bfac563172c19bcb/b5c0e8a955b0cf788391352a767dfc91.jpg'] },
      { name: 'Graphit / Weiss', color: '#686870', images: ['https://upload-bxp-mfm.marya.ru/iblock/cc0/cc09817cb7ce1d7ab1e19725b1028aa9/58f1e2b57f8f4ed743ebb87f40626737.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/37a/37a515db1dc74535857a24529b5779fc/a1a59b3be33593775e8a08faa94073b4.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/e78/e782f119c345bb9b1d6b4c72e63aebcb/9d66a403367d58e107dc6f0dad79e040.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/e78/e782f119c345bb9b1d6b4c72e63aebcb/9d66a403367d58e107dc6f0dad79e040.jpg', icon: '◇', title: 'Materialvielfalt', text: 'Kombinieren Sie Holzdekor, Matt-Lack und Glas in einem Schrank.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0a3/0a362dee5784b900bfac563172c19bcb/b5c0e8a955b0cf788391352a767dfc91.jpg', icon: '▦', title: 'Robuste Konstruktion', text: 'Stabile Verbindungen und hochwertige Scharniere für jahrelange Langlebigkeit.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/cc0/cc09817cb7ce1d7ab1e19725b1028aa9/58f1e2b57f8f4ed743ebb87f40626737.jpg', icon: '▯', title: 'Durchdachte Inneneinteilung', text: 'Kleiderstangen, Schubladen und verstellbare Böden für maximale Ordnung.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/37a/37a515db1dc74535857a24529b5779fc/a1a59b3be33593775e8a08faa94073b4.jpg', icon: '◈', title: 'Massgefertigt', text: 'Jede Einheit wird auf Ihren Raum zugeschnitten — in Breite, Höhe und Tiefe.' },
    ],
  },
  'vector-cabinet': {
    name: 'Vector Schrank',
    ...
    price: 'ab CHF 15',
    variants: [
      { name: 'Weiss Seidenmatt', color: '#f0eeeb', images: ['https://upload-bxp-mfm.marya.ru/iblock/30c/30c5baaedf8e180d805775514ce594d8/4d1f3b36c1b955738e378e663d596fb4.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/555/55568ab32f614bf63419293e2641275d/d175142e857f306a84f2c60fb7cc68e9.jpg'] },
      { name: 'Basaltgrau Matt', color: '#606068', images: ['https://upload-bxp-mfm.marya.ru/iblock/50e/50e4990d6294cb6341c65302e722aaff/0f2afffaa19da420141edfef5b6af9af.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/a67/a67f06fd031f7fb183dd9115bca0fec3/a7fafff86a55778e59ab45a1edc5683b.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
      { label: 'Material', value: 'MDF lackiert' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/30c/30c5baaedf8e180d805775514ce594d8/4d1f3b36c1b955738e378e663d596fb4.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/30c/30c5baaedf8e180d805775514ce594d8/4d1f3b36c1b955738e378e663d596fb4.jpg', icon: '◇', title: 'Horizontale Linienführung', text: 'Feine Fräslinien gliedern die Frontfläche — ruhig, präzise, modern.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/555/55568ab32f614bf63419293e2641275d/d175142e857f306a84f2c60fb7cc68e9.jpg', icon: '▦', title: 'Alu-Griffleiste', text: 'Umlaufende Aluminiumleiste als Griff und Designelement in einem.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/50e/50e4990d6294cb6341c65302e722aaff/0f2afffaa19da420141edfef5b6af9af.jpg', icon: '▯', title: 'Hochwertige Lacke', text: 'Kratzfester Lack in vielen NCS-Tönen — langlebig und pflegeleicht.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/a67/a67f06fd031f7fb183dd9115bca0fec3/a7fafff86a55778e59ab45a1edc5683b.jpg', icon: '◈', title: 'Raumhoch nach Mass', text: 'Vom Boden bis zur Decke für ein nahtloses, architektonisches Gesamtbild.' },
    ],
  },
  'jazz-cabinet': {
    name: 'Jazz Schrank',
    ...
    price: 'ab CHF 12',
    variants: [
      { name: 'Weiss Matt', color: '#eeecec', images: ['https://upload-bxp-mfm.marya.ru/iblock/41e/41e9bd7bf2c461563445a8ab2e130c76/fc6fa4514f9e7f00421d01119211d555.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/65f/65f6f84aa47ad13629f893303736fe79/db53c589c2c71edf9c15cff02095a649.jpg'] },
      { name: 'Schiefer NCS', color: '#787870', images: ['https://upload-bxp-mfm.marya.ru/iblock/fe1/fe192ecc89dca3a8d4c4d3629042b4a0/f296dd17f9b554063edfd1831217f10f.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/0b2/0b2556901ee4d98190313a4d3a3a7241/ca895d1cb8b2fa151d6a864423245981.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
      { label: 'Material', value: 'MDF lackiert' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/41e/41e9bd7bf2c461563445a8ab2e130c76/fc6fa4514f9e7f00421d01119211d555.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/41e/41e9bd7bf2c461563445a8ab2e130c76/fc6fa4514f9e7f00421d01119211d555.jpg', icon: '◇', title: 'Grifflose Fronten', text: 'Fräsung statt Griff — puristisch, kindersicher und immer sauber.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/65f/65f6f84aa47ad13629f893303736fe79/db53c589c2c71edf9c15cff02095a649.jpg', icon: '▦', title: 'Klare Proportionen', text: 'Gleichmässig gegliederte Frontflächen für ein ruhiges, geordnetes Erscheinungsbild.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/fe1/fe192ecc89dca3a8d4c4d3629042b4a0/f296dd17f9b554063edfd1831217f10f.jpg', icon: '▯', title: 'Matte Oberfläche', text: 'Fingerabdruckresistent und pflegeleicht — ideal für Familien mit Kindern.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0b2/0b2556901ee4d98190313a4d3a3a7241/ca895d1cb8b2fa151d6a864423245981.jpg', icon: '◈', title: 'Flexibel konfigurierbar', text: 'Hängebereiche, Schubladen, Schuhfächer — individuell nach Bedarf.' },
    ],
  },
  'ice-cabinet': {
    name: 'Ice Schrank',
    ...
    price: 'ab CHF 11',
    variants: [
      { name: 'Eisweiss Hochglanz', color: '#f5f5f8', images: ['https://upload-bxp-mfm.marya.ru/iblock/0c2/0c2877c7783f3585992ccef0282a3cb5/215187ebeb924658120cb1373a7aac03.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/a37/a37e3bbf1c4c50ffef32693cfcd58fd7/ff00d21a3249642157bc86d56684c887.jpg'] },
      { name: 'Silber Metallic', color: '#b8c0c8', images: ['https://upload-bxp-mfm.marya.ru/iblock/f96/f962011cec317eddae540d457ae05424/e486d93956cd12ebede7be6a4ed57c76.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/d87/d87e00522a894b2015217299be4a1260/a62062df65f1e6e8e2bba39ed65cb923.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/0c2/0c2877c7783f3585992ccef0282a3cb5/215187ebeb924658120cb1373a7aac03.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0c2/0c2877c7783f3585992ccef0282a3cb5/215187ebeb924658120cb1373a7aac03.jpg', icon: '◇', title: 'Hochglanz-Wirkung', text: 'Spiegelnde Oberfläche reflektiert Licht und vergrössert den Raum optisch.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/a37/a37e3bbf1c4c50ffef32693cfcd58fd7/ff00d21a3249642157bc86d56684c887.jpg', icon: '▦', title: 'Einfache Reinigung', text: 'Glatte, geschlossene Oberfläche ohne Poren — schnell sauber gemacht.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/f96/f962011cec317eddae540d457ae05424/e486d93956cd12ebede7be6a4ed57c76.jpg', icon: '▯', title: 'Moderne Optik', text: 'Klares Design ohne überflüssige Details — zeitlos und immer aktuell.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/d87/d87e00522a894b2015217299be4a1260/a62062df65f1e6e8e2bba39ed65cb923.jpg', icon: '◈', title: 'Massgefertigt', text: 'Auf Ihre Raummasse zugeschnitten — kein Millimeter verschwendet.' },
    ],
  },
  'integrato-cabinet': {
    ...
    price: 'ab CHF 13',
    variants: [
      { name: 'Weiss Email Matt', color: '#f2f0ed', images: ['https://upload-bxp-mfm.marya.ru/iblock/bfe/bfe87d69b9b43d17711eac364837b553/79812540060e76b573d232ab3f9c22f4.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/29d/29dc0e90c46c01b170e42658e99c304c/45a5b55f9fe0c6bad468b8043102ece5.jpg'] },
      { name: 'Grau Email Matt', color: '#a0a0a8', images: ['https://upload-bxp-mfm.marya.ru/iblock/770/7708e965140e91f9684efd727547e2f5/c1c3cc0c6adca81a76f38744ff0fa178.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/cfd/cfda14da2e500034aee03df2c4f03140/3a87aea9d8a9744a70ea184deb847a9e.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
      { label: 'Material', value: 'MDF 22 mm + Emaille' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/bfe/bfe87d69b9b43d17711eac364837b553/79812540060e76b573d232ab3f9c22f4.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/bfe/bfe87d69b9b43d17711eac364837b553/79812540060e76b573d232ab3f9c22f4.jpg', icon: '◇', title: 'Email-Oberfläche', text: 'Langlebige Emaillebeschichtung — kratzfest, pflegeleicht, jahrelang schön.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/29d/29dc0e90c46c01b170e42658e99c304c/45a5b55f9fe0c6bad468b8043102ece5.jpg', icon: '▦', title: 'Grifflose Front', text: 'Fräsung statt Griff — maximaler Minimalismus ohne Abstriche beim Komfort.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/770/7708e965140e91f9684efd727547e2f5/c1c3cc0c6adca81a76f38744ff0fa178.jpg', icon: '▯', title: 'Klare Geometrie', text: 'Präzise Proportionen und plane Flächen für ein ruhiges, modernes Raumgefühl.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/cfd/cfda14da2e500034aee03df2c4f03140/3a87aea9d8a9744a70ea184deb847a9e.jpg', icon: '◈', title: 'Maximale Innenraumnutzung', text: 'Durchdachte Innenaufteilung mit Platz für Kleidung, Wäsche und Zubehör.' },
    ],
  },
  'camelia-cabinet': {
    ...
    price: 'ab CHF 14',
    variants: [
      { name: 'Elfenbein Seidenmatt', color: '#e8e0d0', images: ['https://upload-bxp-mfm.marya.ru/iblock/3ff/3ffa6a1bf32ba41e1802155c67b23283/69eca5fe1f6bfd85593acd6ebdc73652.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/bb5/bb56ea9c0bf573d14d815e330f0e0b08/0df0212946e360ede96d1b4bc3bc7c55.jpg'] },
      { name: 'Cashmere Rosa', color: '#e0c8c0', images: ['https://upload-bxp-mfm.marya.ru/iblock/078/0784ef6386932f4f1a40bf98d8fe04ea/d29ffbfca9570c890ba444a9c1c7ccb7.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/c17/c1798cf8267b15196ac18eb7cb7f1918/0633b1096ed3d65aaec6042130c0a363.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
      { label: 'Material', value: 'MDF lackiert' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/3ff/3ffa6a1bf32ba41e1802155c67b23283/69eca5fe1f6bfd85593acd6ebdc73652.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/3ff/3ffa6a1bf32ba41e1802155c67b23283/69eca5fe1f6bfd85593acd6ebdc73652.jpg', icon: '◇', title: 'Filigrane Rahmenprofile', text: 'Zarte Rahmenprofile verleihen dem Schrank eine klassisch-elegante Anmutung.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/bb5/bb56ea9c0bf573d14d815e330f0e0b08/0df0212946e360ede96d1b4bc3bc7c55.jpg', icon: '▦', title: 'Edle Möbelgriffe', text: 'Hochwertige Griffe in verschiedenen Ausführungen als stilvolles Detail.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/078/0784ef6386932f4f1a40bf98d8fe04ea/d29ffbfca9570c890ba444a9c1c7ccb7.jpg', icon: '▯', title: 'Zeitlose Farben', text: 'Von Elfenbein bis Cashmere — sanfte Töne, die zu jedem Einrichtungsstil passen.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/c17/c1798cf8267b15196ac18eb7cb7f1918/0633b1096ed3d65aaec6042130c0a363.jpg', icon: '◈', title: 'Massgefertigt', text: 'Jeder Schrank wird nach Ihren Raummassen und Wünschen gefertigt.' },
    ],
  },
  'antro-cabinet': {
    name: 'Antro Schrank',
    ...
    price: 'ab CHF 15',
    variants: [
      { name: 'Steinoptik Grau', color: '#909090', images: ['https://upload-bxp-mfm.marya.ru/iblock/f86/f86da75fb826a8b26d173db3cf6f1a2c/92d576ae7acc9771c78af538da6bd36f.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/197/1978c017d33d5051aeedc4c000aaa214/b6eb8538fb60f9e8803a9348a329f09e.jpg'] },
      { name: 'Holzdekor Walnuss', color: '#7a5030', images: ['https://upload-bxp-mfm.marya.ru/iblock/0c8/0c88a6eddf8744885d04ea9d7e99e017/f4e22fe3ab7299522ab8e2d377c62a04.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/807/8078b9f8c34b0d8a254360964ec852aa/68eccfec3fcffd9dcd4b1b0e3071249f.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/f86/f86da75fb826a8b26d173db3cf6f1a2c/92d576ae7acc9771c78af538da6bd36f.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/f86/f86da75fb826a8b26d173db3cf6f1a2c/92d576ae7acc9771c78af538da6bd36f.jpg', icon: '◇', title: 'Steinoptik-Fronten', text: 'Authentische Steinstruktur auf MDF — edel aussehend, leicht pflegbar.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/197/1978c017d33d5051aeedc4c000aaa214/b6eb8538fb60f9e8803a9348a329f09e.jpg', icon: '▦', title: 'Organische Texturen', text: 'Jede Front wirkt wie ein Naturmaterial — einzigartig und charaktervoll.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0c8/0c88a6eddf8744885d04ea9d7e99e017/f4e22fe3ab7299522ab8e2d377c62a04.jpg', icon: '▯', title: 'Naturholz-Dekor', text: 'Eiche, Walnuss oder Pinie — echte Holzdekore bringen Wärme in den Raum.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/807/8078b9f8c34b0d8a254360964ec852aa/68eccfec3fcffd9dcd4b1b0e3071249f.jpg', icon: '◈', title: 'Robuste Oberfläche', text: 'Kratzfeste Beschichtung, die täglich belastet werden kann.' },
    ],
  },
  'trento-cabinet': {
    name: 'Trento Schrank',
    ...
    price: 'ab CHF 13',
    variants: [
      { name: 'Cremeweiss Email', color: '#f0ece0', images: ['https://upload-bxp-mfm.marya.ru/iblock/460/46098622bcb403c1ce9066b33c8ebde2/bd01cbb9ebb77ba2d495cea6aa04f6ad.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/aa1/aa15a1f003036a3c9f60ae12437edda6/4fc1618422a6183e874632c201e5ba57.jpg'] },
      { name: 'Granitgrau Email', color: '#787878', images: ['https://upload-bxp-mfm.marya.ru/iblock/f15/f158a6bbe77b01e72c086c2904aba589/663943c2527239a727b1f2b555fd1937.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/ffa/ffa5010a93cfeed153760243aeb6e1ee/30bda8c359161d8808845c2d28c5e710.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/460/46098622bcb403c1ce9066b33c8ebde2/bd01cbb9ebb77ba2d495cea6aa04f6ad.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/460/46098622bcb403c1ce9066b33c8ebde2/bd01cbb9ebb77ba2d495cea6aa04f6ad.jpg', icon: '◇', title: 'Email-Beschichtung', text: 'Hochwertige Emaillebeschichtung — strapazierfähig, pflegeleicht und langlebig.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/aa1/aa15a1f003036a3c9f60ae12437edda6/4fc1618422a6183e874632c201e5ba57.jpg', icon: '▦', title: 'Samtig-matte Oberfläche', text: 'Angenehme Haptik und elegante Optik — fingerabdruckresistent und zeitlos.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/f15/f158a6bbe77b01e72c086c2904aba589/663943c2527239a727b1f2b555fd1937.jpg', icon: '▯', title: 'Klassische Proportionen', text: 'Ausgewogene Masse für ein harmonisches Raumgefühl.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/ffa/ffa5010a93cfeed153760243aeb6e1ee/30bda8c359161d8808845c2d28c5e710.jpg', icon: '◈', title: 'Passend zur Küche', text: 'Kombinierbar mit Trento Küche für ein einheitliches Wohnkonzept.' },
    ],
  },
  'allure-cabinet': {
    ...
    price: 'ab CHF 16',
    variants: [
      { name: 'Grauweiss Matt', color: '#e8e4de', images: ['https://upload-bxp-mfm.marya.ru/iblock/8a0/8a0034a25369fa6fe8ac92aa4f29fd61/00a6a152f109df947ebfb383c1298965.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/2a6/2a62ca4b2b4c5c9896ec127fa08f3228/be0583385e053fd140547030c0721f2d.jpg'] },
      { name: 'Cashmere NCS', color: '#d0c0a8', images: ['https://upload-bxp-mfm.marya.ru/iblock/af9/af97314c4c543726fee2b3c1cc18d3a3/b6b13df320802b3ee20e9a9931ed1b39.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/84d/84dce614f057a6fb1f384bb4bcb13313/06748076dc2e8c11fce5a1424420cfd2.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/8a0/8a0034a25369fa6fe8ac92aa4f29fd61/00a6a152f109df947ebfb383c1298965.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/8a0/8a0034a25369fa6fe8ac92aa4f29fd61/00a6a152f109df947ebfb383c1298965.jpg', icon: '◇', title: 'Klassisches Profil', text: 'Profilierte Rahmenelemente verleihen dem Schrank einen eleganten Charakter.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/2a6/2a62ca4b2b4c5c9896ec127fa08f3228/be0583385e053fd140547030c0721f2d.jpg', icon: '▦', title: 'Edle Messinggriffe', text: 'Optionale Griffe in Messing oder Chrom setzen luxuriöse Akzente.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/af9/af97314c4c543726fee2b3c1cc18d3a3/b6b13df320802b3ee20e9a9931ed1b39.jpg', icon: '▯', title: 'Breite Farbauswahl', text: 'RAL und NCS Farbtöne in unbegrenzter Auswahl — passend zu Ihrem Zuhause.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/84d/84dce614f057a6fb1f384bb4bcb13313/06748076dc2e8c11fce5a1424420cfd2.jpg', icon: '◈', title: 'Massgefertigt', text: 'Jede Einheit wird exakt auf Ihre Raummasse angepasst — vom Boden bis zur Decke.' },
    ],
  },
  'tokyo-cabinet': {
    name: 'Tokyo Schrank',
    ...
    price: 'ab CHF 11',
    variants: [
      { name: 'Weiss Matt', color: '#efefed', images: ['https://upload-bxp-mfm.marya.ru/iblock/0c5/0c5be3a97afe094ff07392a40429efd4/38ddb963a6f7543dc72ebad6370cf58c.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/ce8/ce8e852967efe6703af979355ceabab2/75e842c2ea0fcb4e2d64ec93a175c429.jpg'] },
      { name: 'Anthrazit Matt', color: '#484848', images: ['https://upload-bxp-mfm.marya.ru/iblock/13c/13c3b66e05c1a412d6acb3af7c065299/cb055543b8cfe592bf07dbf78bad7d06.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/5f9/5f94b43e2287bc70625a15d6954a739d/ceab8b038c7b4197662a554b12d6e1e9.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
      { label: 'Material', value: 'MDF lackiert' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/0c5/0c5be3a97afe094ff07392a40429efd4/38ddb963a6f7543dc72ebad6370cf58c.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0c5/0c5be3a97afe094ff07392a40429efd4/38ddb963a6f7543dc72ebad6370cf58c.jpg', icon: '◇', title: 'Fernöstlicher Minimalismus', text: 'Klare Formen, keine Ornamente — Schönheit durch Reduktion.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/ce8/ce8e852967efe6703af979355ceabab2/75e842c2ea0fcb4e2d64ec93a175c429.jpg', icon: '▦', title: 'Schlankes Profil', text: 'Schmale Frontstärken für ein leichtes, elegantes Erscheinungsbild.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/13c/13c3b66e05c1a412d6acb3af7c065299/cb055543b8cfe592bf07dbf78bad7d06.jpg', icon: '▯', title: 'Matte Oberfläche', text: 'Samtig-mattes Finish, fingerabdruckresistent und immer gepflegt.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/5f9/5f94b43e2287bc70625a15d6954a739d/ceab8b038c7b4197662a554b12d6e1e9.jpg', icon: '◈', title: 'Für jeden Raum', text: 'Verfügbar in vielen Breiten und Höhen — ideal für Schlaf-, Kinder- oder Bürozimmer.' },
    ],
  },
  'tokyo-glyanets-cabinet': {
    ...
    price: 'ab CHF 12',
    variants: [
      { name: 'Weiss Hochglanz', color: '#f5f5f0', images: ['https://upload-bxp-mfm.marya.ru/iblock/d6f/d6f83a7c9a86bcb293e3f68a2d152205/bd240992b1d02ab036b6a956c2855c19.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/a07/a07afc8a2ec85d39851beccc5f89228c/4836560adab1bb8eb998ee2d66f24174.jpg'] },
      { name: 'Silber Hochglanz', color: '#c8c8d0', images: ['https://upload-bxp-mfm.marya.ru/iblock/747/7473a224a687e5a3bf299b2acb37e23a/a1bd09806dc79f42f609f7bf6f9f8317.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/0f1/0f1636b92d8715fbe4d63acbd5813a52/16598608d9fb8061cfaff10ac164bed7.jpg'] },
    ],
    specs: [
      { label: 'Typ', value: 'Drehtürenschrank' },
      { label: 'Oberfläche', value: 'PVC Hochglanz' },
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/d6f/d6f83a7c9a86bcb293e3f68a2d152205/bd240992b1d02ab036b6a956c2855c19.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/d6f/d6f83a7c9a86bcb293e3f68a2d152205/bd240992b1d02ab036b6a956c2855c19.jpg', icon: '◇', title: 'Spiegelnde Optik', text: 'Hochglanzfronten reflektieren Licht und lassen den Raum grösser wirken.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/a07/a07afc8a2ec85d39851beccc5f89228c/4836560adab1bb8eb998ee2d66f24174.jpg', icon: '▦', title: 'Einfache Reinigung', text: 'Glatte, porenfreie Fläche — mit einem feuchten Tuch in Sekunden sauber.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/747/7473a224a687e5a3bf299b2acb37e23a/a1bd09806dc79f42f609f7bf6f9f8317.jpg', icon: '▯', title: 'Tokyo-Minimalismus', text: 'Klare Formen ohne überflüssige Details — Tokyo-Stil im Schlafzimmer.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/0f1/0f1636b92d8715fbe4d63acbd5813a52/16598608d9fb8061cfaff10ac164bed7.jpg', icon: '◈', title: 'Massgefertigt', text: 'Auf Ihre Raummasse zugeschnitten — kein Millimeter verschwendet.' },
    ],
  },
  'optima-dressing': {
    ...
    price: 'ab CHF 18',
    variants: [
      { name: 'Weiss Matt', color: '#f0eeeb', images: ['https://upload-bxp-mfm.marya.ru/iblock/396/396aee7821bdbcbc2d8c8bfc8880d1ca/694f5b1638d08c50e30c23a45bf50d44.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/81c/81c63ef6dea0eb622a2926690a779c7b/6ca6eaeb1fc4e026a121756037673dd9.jpg'] },
      { name: 'Eiche Natur', color: '#c0a060', images: ['https://upload-bxp-mfm.marya.ru/iblock/161/1617afa1ee74150fc1e1b48597c188ef/848103ef1e10cfa589062993ff087205.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/03b/03b694b5cbc377d8856e00bf221726c2/898d70bb2b670c231f4e07d7641384dc.jpg'] },
    ],
    specs: [
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/396/396aee7821bdbcbc2d8c8bfc8880d1ca/694f5b1638d08c50e30c23a45bf50d44.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/396/396aee7821bdbcbc2d8c8bfc8880d1ca/694f5b1638d08c50e30c23a45bf50d44.jpg', icon: '◇', title: 'Modulares System', text: 'Frei kombinierbare Module — planen Sie Ihr Traumankleidezimmer nach Ihren Bedürfnissen.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/81c/81c63ef6dea0eb622a2926690a779c7b/6ca6eaeb1fc4e026a121756037673dd9.jpg', icon: '▦', title: 'Vielfältige Innenausstattung', text: 'Hängebereiche, Schubladen, Schuhregale und offene Fächer — alles nach Plan.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/161/1617afa1ee74150fc1e1b48597c188ef/848103ef1e10cfa589062993ff087205.jpg', icon: '▯', title: 'LED-Beleuchtung', text: 'Integrierte LED-Streifen beleuchten jeden Winkel Ihrer Garderobe perfekt.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/03b/03b694b5cbc377d8856e00bf221726c2/898d70bb2b670c231f4e07d7641384dc.jpg', icon: '◈', title: 'Massgeplant', text: 'Unsere Designer planen Ihr Ankleidezimmer kostenlos nach Ihrem Grundriss.' },
    ],
  },
  'stilos': {
    ...
    price: 'ab CHF 22',
    variants: [
      { name: 'Glas / Weiss Rahmen', color: '#e8eef0', images: ['https://upload-bxp-mfm.marya.ru/iblock/888/888edd15fac0e6f0a004b83e167b94b9/b53de321077cb44f2717b0b413e8f876.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/78c/78c6b4230d95b147039e585f0b0b209f/cbdaee5a1b4614182908f5d1eb3f8209.jpg'] },
      { name: 'Glas / Alu Rahmen', color: '#c0c8d0', images: ['https://upload-bxp-mfm.marya.ru/iblock/e8c/e8c92ee45fb689f05bf381cb5ce9b353/757bd8c5c3487a2c42ec0a0de28bc4c0.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/766/7666f6aaf63e3b3af5ab2a0795739ac2/6b093a5d13ae291af6895891f2ec70eb.jpg'] },
    ],
    specs: [
    ...
    featureImg: 'https://upload-bxp-mfm.marya.ru/iblock/888/888edd15fac0e6f0a004b83e167b94b9/b53de321077cb44f2717b0b413e8f876.jpg',
    features: [
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/888/888edd15fac0e6f0a004b83e167b94b9/b53de321077cb44f2717b0b413e8f876.jpg', icon: '◇', title: 'Glasfronten', text: 'Durchsichtige oder mattierte Glasfronten geben dem Ankleidezimmer ein edles Erscheinungsbild.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/78c/78c6b4230d95b147039e585f0b0b209f/cbdaee5a1b4614182908f5d1eb3f8209.jpg', icon: '▦', title: 'Aluminium-Rahmenstruktur', text: 'Stabile Aluprofile bilden die Konstruktion — leicht, robust und dauerhaft.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/e8c/e8c92ee45fb689f05bf381cb5ce9b353/757bd8c5c3487a2c42ec0a0de28bc4c0.jpg', icon: '▯', title: 'Sichtbarer Inhalt', text: 'Durch die Glasfronten sehen Sie sofort, was wo liegt — keine Suche mehr.' },
      { img: 'https://upload-bxp-mfm.marya.ru/iblock/766/7666f6aaf63e3b3af5ab2a0795739ac2/6b093a5d13ae291af6895891f2ec70eb.jpg', icon: '◈', title: 'Kostenlose Planung', text: 'Wir planen Ihr Stilos-Ankleidezimmer gratis nach Ihrem Grundriss und Wünschen.' },
    ],
  },
  'jazz-allure': {
    name: 'Jazz Allure',
    ...
    price: 'ab CHF 48',
    variants: [
      { name: 'Grauweiss Matt', color: '#e8e4e0', images: ['https://upload-bxp-mfm.marya.ru/iblock/ba2/ba268b7026920fa148416336fa32f631/ff9a710b148730a1d74acffdc6d6c965.jpg', 'https://upload-bxp-mfm.marya.ru/iblock/b37/b375bf88b96a066dbc5c9d558788f2b5/7bb2969b85714d86d3a1b3c0a59b6e05.jpg'] },
  ...
  'grafis': {
    ...
    variants: [
      { name: 'Schwarz Matt', color: '#1a1a1a', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files/07pxOyAzMM8LAKQhj_P1p1s.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0inf0eZjq9vaH2cmA_pZDlb.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0sVGUq1zdKqpIvx0E_cEPjn.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0Dq6djgvGQ47gNn7E_XKby1.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/05StiwvLV5lZ2NBOa_fBvCw.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0G64ypiHxd7dC8yx8_PoRAd.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/01otTiimDoE10ulNg_j20gC.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0iOw6GhF1AgLtagdl_fZBDV.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0WMba2hhJJuAm75oJ_8jOID.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0qU8c0EkW2qe2jly7_0W5kx.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/09KuzubGY7LuzR2Rl_eU9OW.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0MWBwkAKGi04aS39l_1h6Pj.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0nJKo1Vj4znXWWHG5_9CtW7.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files/0nUCqy3iOzLHNR8xs_ni5kR.jpg',
      ]},
    ],
    specs: [
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files/07pxOyAzMM8LAKQhj_P1p1s.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Графис__93pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files/07pxOyAzMM8LAKQhj_P1p1s.jpg', icon: '◇', title: 'Griffloses Design', text: 'Maximale Reinheit und minimalistische Ästhetik — keine sichtbaren Griffe stören die klare Linienführung.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files/0inf0eZjq9vaH2cmA_pZDlb.jpg', icon: '▦', title: 'Kratzfeste Oberfläche', text: 'Hochwertige Kunststoff-Beschichtung schützt dauerhaft vor Kratzern, Feuchtigkeit und Temperaturschwankungen.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files/0sVGUq1zdKqpIvx0E_cEPjn.jpg', icon: '▯', title: 'Individuelle Planung', text: 'Jede Küche wird massgenau für Ihren Raum geplant — exakt nach Ihren Wünschen und Massen.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files/0Dq6djgvGQ47gNn7E_XKby1.jpg', icon: '◈', title: '20 Jahre Garantie', text: 'Wir bieten eine umfassende Herstellergarantie — für langfristige Freude an Ihrer Küche.' },
    ],
  },
  'granby': {
    name: 'Granby',
    ...
    variants: [
      { name: 'Grau Matt', color: '#888888', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0cZ3AVTlSyxPUwLgW_fAZRl.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/04PgbGC2Y0hQFGGnD_AqQD0.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0pbEuxLBCeovCt1KW_Q7xPM.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0Ezj1sQOCnRvwEX4O_Mb7hw.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0GBQ4bBYtBzXJkIq9_FlXgK.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0nuOZBdQhDqqgURFe_57t0o.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0orIneKVbMTPezMJh_Uq9Gl.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/01OPx1AtpeFl9LuH5_leZZA.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0eLBFFmuxVN0VbwDi_DeFWk.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0Ijp7IMdw4eobSkyj_kg2fW.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0NhYb24Hrhw9JSenc_cMCOF.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0Qng2z1PDHWlZMuan_bpUCj.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0ktuahH6W6cjbKHYc_Y3qVv.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0mvTpr8vqXDbmfbVu_a7Ibt.jpg',
      ]},
    ],
    specs: [
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0cZ3AVTlSyxPUwLgW_fAZRl.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Гранби3__92pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0cZ3AVTlSyxPUwLgW_fAZRl.jpg', icon: '◇', title: 'Zeitlose Grautöne', text: 'Grau bleibt immer modern — Granby bietet eine breite Palette von Hellgrau bis Anthrazit für jeden Geschmack.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/04PgbGC2Y0hQFGGnD_AqQD0.jpg', icon: '▦', title: 'Email-Lack Qualität', text: 'Hochwertige Email-Lackierung auf MDF — strapazierfähig, farbecht und über Jahre makellos schön.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0pbEuxLBCeovCt1KW_Q7xPM.jpg', icon: '▯', title: 'Europäische Beschläge', text: 'Blum- und Hettich-Beschläge mit über 80.000 Zyklen Lebensdauer — geräuschloses Schliessen inklusive.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0Ezj1sQOCnRvwEX4O_Mb7hw.jpg', icon: '◈', title: 'Massgefertigt für die Schweiz', text: 'Jedes Möbel wird individuell nach Ihrem Grundriss und Ihren Wünschen geplant und gefertigt.' },
    ],
  },
  'budbin': {
    name: 'Budbin',
    ...
    variants: [
      { name: 'Weiss Hochglanz', color: '#f5f5f5', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0jifM8SdyZJQgxzHv_flxWI.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0yeIHaM1UKb5k81aD_nShcX.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0UIUgObC2HfprzXhE_CP4o5.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0TO1dM58rr2gfVt4g_6YfjW.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0I7IgL4A0D0vTYI6B_h2QUK.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/09ppwlqQ3bqG6FPwZ_Mtt8x.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/08ZtrRMLF9s0cTMgW_syIqL.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0V7C0tBS6mAq2nzDR_OhwQC.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0C6bZZg4YZair8SC1_G9PF4.jpg',
      ]},
    ],
    specs: [
      { label: 'Material', value: 'PVC-Folie / Email-Lack' },
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0jifM8SdyZJQgxzHv_flxWI.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Будбин__93pct_smaller.mp4',
      null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0jifM8SdyZJQgxzHv_flxWI.jpg', icon: '◇', title: 'Strahlendes Weiss', text: 'Weiss schafft Weite und Helligkeit — Budbin nutzt diesen Effekt optimal mit matten und glänzenden Frontoptionen.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0yeIHaM1UKb5k81aD_nShcX.jpg', icon: '▦', title: 'Pflegeleichte Oberflächen', text: 'Die Frontbeschichtung stösst Schmutz und Fett ab — ein feuchtes Tuch genügt für die tägliche Reinigung.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0UIUgObC2HfprzXhE_CP4o5.jpg', icon: '▯', title: 'Intelligenter Stauraum', text: 'Durchdachte Innenausstattung mit Vollauszügen und variablen Regalen für maximale Effizienz auf kleinstem Raum.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0TO1dM58rr2gfVt4g_6YfjW.jpg', icon: '◈', title: 'Langlebige Qualität', text: 'Zertifizierte Materialien nach Schweizer Standard — bis zu 20 Jahre Garantie auf alle Möbel.' },
    ],
  },
  'kolaria': {
    name: 'Kolaria',
    ...
    variants: [
      { name: 'Weiss PVC', color: '#f5f5f5', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0kesx1Y2Pt92wkDDx_04Vkl.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/09NhXpu98iGJEySEn_65TT4.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0clor9XYx7kFblogY_4mJKE.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0VOgYBZv53tBUyVOl_c4r80.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0pWdToX8vT3ltw80U_Sz1UA.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0dFQdEndDqWCjB2NW_OhScL.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0jHz23YKDu0ja1JpC_qxKoh.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0AeIRvirCbXC1ARDw_swDfA.jpg',
      ]},
    ],
    specs: [
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0kesx1Y2Pt92wkDDx_04Vkl.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Колария__92pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0kesx1Y2Pt92wkDDx_04Vkl.jpg', icon: '◇', title: 'Vier Frontmaterialien', text: 'PVC, Kunststoff, Email oder Acryl — wählen Sie das Material, das zu Ihrem Lebensstil und Budget passt.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/09NhXpu98iGJEySEn_65TT4.jpg', icon: '▦', title: 'Acryl-Hochglanz', text: 'Acryl-Fronten spiegeln das Licht und lassen Räume grösser wirken — pflegeleicht und ausdrucksstark.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0clor9XYx7kFblogY_4mJKE.jpg', icon: '▯', title: 'Kratzfeste Beschichtung', text: 'Kunststoff-Fronten widersetzen sich Kratzern und heissem Geschirr — robuste Qualität für den Alltag.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0VOgYBZv53tBUyVOl_c4r80.jpg', icon: '◈', title: 'Individuelle Planung', text: 'Alle vier Materialien kombinierbar — für ein stimmiges Gesamtbild nach Ihrem persönlichen Geschmack.' },
    ],
  },
'roshedu': {
    name: 'Roshedu',
    ...
    variants: [
      { name: 'Nussbaum Dunkel', color: '#3d2b1f', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/097K8FXmtcZoVqJVy_lu4a1.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/01fzODmKRtoACKIqP_SNR4S.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/09OlMNCCasbZch57a_8y4Tn.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0iGPVbebDtfvbxgis_cvQhd.jpg',
      ]},
    ],
    specs: [
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/097K8FXmtcZoVqJVy_lu4a1.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Рошеду__84pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/097K8FXmtcZoVqJVy_lu4a1.jpg', icon: '◇', title: 'Dunkle Eleganz', text: 'Tiefe Braun- und Nussbaumtöne verleihen Ihrer Küche eine edle, elegante Ausstrahlung.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/01fzODmKRtoACKIqP_SNR4S.jpg', icon: '▦', title: 'Holzstruktur', text: 'Echtholz-Furnier mit natürlicher Maserung — jedes Element ist ein Unikat.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/09OlMNCCasbZch57a_8y4Tn.jpg', icon: '▯', title: 'Mattierte Oberflächen', text: 'Samtmattierte Fronten fühlen sich warm an und sind gleichzeitig extrem widerstandsfähig.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0iGPVbebDtfvbxgis_cvQhd.jpg', icon: '◈', title: 'Zeitloses Design', text: 'Die Kombination aus Tradition und Moderne macht Roshedu zu einem Modell für Generationen.' },
    ],
  },
'brix': {
    name: 'Brix',
    ...
    variants: [
      { name: 'Weiss PVC', color: '#f5f5f5', images: ['https://kuhnimilana.ru/media-temp/img/goods/files/0q9jxltANXHL3RmIm_2b9zJ.jpg', 'https://www.marya.ru/promo/home3/img/models/avenue.jpg'] },
      { name: 'Acryl Weiss', color: '#fafafa', images: ['https://www.marya.ru/promo/home3/img/models/nicolle.jpg', 'https://www.marya.ru/promo/home3/img/models/trento1.jpg'] },
      { name: 'Kunststoff Matt', color: '#ececec', images: ['https://www.marya.ru/promo/home3/img/models/mix22.jpg', 'https://www.marya.ru/promo/home3/img/models/jazz.jpg'] },
    ],
    specs: [
      { label: 'Material', value: 'PVC / Kunststoff / Email / Acryl' },
      { label: 'Stil', value: 'Modern' },
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files/0q9jxltANXHL3RmIm_2b9zJ.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Брикс__92pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files/0q9jxltANXHL3RmIm_2b9zJ.jpg', icon: '◇', title: 'Maximale Flexibilität', text: 'Vier Frontmaterialien in einer Küche kombinierbar — für ein einzigartiges, persönliches Küchendesign.' },
      { img: 'https://www.marya.ru/promo/home3/img/models/avenue.jpg', icon: '▦', title: 'Helle Wirkung', text: 'Weisse Fronten in Hochglanz oder Matt lassen auch kleine Küchen optisch grösser und freundlicher wirken.' },
      { img: 'https://www.marya.ru/promo/home3/img/models/nicolle.jpg', icon: '▯', title: 'Hitzebeständige Oberflächen', text: 'Kunststoff und PVC-Fronten sind hitze- und feuchtigkeitsbeständig — ideal für den täglichen Küchenalltag.' },
      { img: 'https://www.marya.ru/promo/home3/img/models/mix22.jpg', icon: '◈', title: 'Schweizer Qualitätsstandard', text: 'Gefertigt nach höchsten Qualitätsstandards — langlebig, schadstoffarm und mit bis zu 20 Jahren Garantie.' },
    ],
  },
'sadbury': {
    name: 'Sadbury',
    ...
    variants: [
      { name: 'Eiche Natur', color: '#b8a088', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/05iefZ2FsYxLSnvb3_z5ytb.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0xSU8DworoUoBaeLz_Njvgd.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0ofRZONTSmNn3QwzH_3Sgne.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0he2FsiD1HMO1uMYB_b0Cww.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0fSyQsV6EYWwSlOeF_vW3jM.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0E52BUKkHIltpq4ZJ_s7hZG.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0Nx3zzLEestMoFO4f_ke8OU.jpg',
      ]},
    ],
    specs: [
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/05iefZ2FsYxLSnvb3_z5ytb.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Садбери__90pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/05iefZ2FsYxLSnvb3_z5ytb.jpg', icon: '◇', title: 'Zeitlose Holzoptik', text: 'Eiche und Naturtöne schaffen eine warme, einladende Atmosphäre, die niemals veraltet.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0xSU8DworoUoBaeLz_Njvgd.jpg', icon: '▦', title: 'Massive Griffe', text: 'Robuste Metallgriffe in verschiedenen Oberflächen — von Chrom bis Messing antik.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0ofRZONTSmNn3QwzH_3Sgne.jpg', icon: '▯', title: 'Familienfreundlich', text: 'Abgerundete Ecken und ausreichend Arbeitsfläche — Sicherheit und Komfort für alle.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0he2FsiD1HMO1uMYB_b0Cww.jpg', icon: '◈', title: 'Viel Stauraum', text: 'Durchdachte Innenausstattung mit Vollauszügen, Eckschränken und integrierten Beleuchtungssystemen.' },
    ],
  },
  'tavira': {
    name: 'Tavira',
    ...
    variants: [
      { name: 'Furnier Eiche', color: '#c8a878', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/04BaGWDW2glkI84IO_Yjrjl.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0j0BVzfwIHhDedTDv_jUGrA.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0UhFGjNG9j9AcJBn6_Y661B.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0mQw7XjFbMX4LaHKG_zklZ1.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0sBMKFCloySpvrCx5_km4kP.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0mPV8F0q9gt1RzDzy_GrYGR.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0UgwSlwaRofYpxHAJ_7GubE.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/05B1JDuvw82r08PxD_eo68Z.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0e4wLtNG12itlm5JA_2RBn1.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0cuFB3sBEFhvyjfbz_DLzY9.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0PChuGAD6zgU8oGA1_HYYk8.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0jzAr9vqA5tdz58aG_BfLLV.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0F4ftbpigC8OAlPaD_BKCJu.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0AbpdiQ3j7Vkh7jU7_iloLe.jpg',
      ]},
    ],
    specs: [
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/04BaGWDW2glkI84IO_Yjrjl.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Тавира__90pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/04BaGWDW2glkI84IO_Yjrjl.jpg', icon: '◇', title: 'Echter Furnier', text: 'Naturfurnier bringt die Wärme und Textur von echtem Holz in Ihre Küche — jedes Stück ein Unikat.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0j0BVzfwIHhDedTDv_jUGrA.jpg', icon: '▦', title: 'UV-Schutzlackierung', text: 'Spezieller Acryllack schützt den Furnier vor Ausbleichen und erhält die natürliche Holzfarbe dauerhaft.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0UhFGjNG9j9AcJBn6_Y661B.jpg', icon: '▯', title: 'Drei Materialien in einem', text: 'PVC, Kunststoff und Furnier kombinierbar — für eine individuelle Küche mit Kontrasten und Harmonie.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0mQw7XjFbMX4LaHKG_zklZ1.jpg', icon: '◈', title: 'Ökologisch zertifiziert', text: 'Alle verwendeten Materialien erfüllen internationale Umweltstandards — sicher für Ihre Familie.' },
    ],
  },
  'richmond': {
    name: 'Richmond',
    ...
    variants: [
      { name: 'Reinweiss Matt', color: '#f8f8f8', images: [
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0LSLx8yb5i198HrrA_hY4iv.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0G650jVmIEfWeXz4E_J3ooX.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0XZTh7oEMuM9SShl8_2MsXh.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0rvO3qDHq57zOREaB_to7yd.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0THRwkPADiGErRSWc_lhBVD.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0xi6GLPxjJR8rxAMW_HloKb.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0pI0L14yi04UqwTE5_Q6TbA.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0rqPgZSMVkLAmizIR_NY3Kr.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0lBTwTVYqMBg06V5H_HxZG2.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0sHmI3SmtPH7NXMae_j2BPF.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0hWu2uhrnELOoJt5o_I3Div.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0WDed54BhHY8C4IFE_lOoCu.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/06Lrt6kdsuPMAoQwg_Te95g.jpg',
        'https://kuhnimilana.ru/media-temp/img/goods/files_big/0FVPNUgWvRVDSF44T_TNz1r.jpg',
      ]},
    ],
    specs: [
      { label: 'Material', value: 'PVC-Folie / Email-Lack' },
    ...
    featureImg: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0LSLx8yb5i198HrrA_hY4iv.jpg',
    videos: [
      'https://kuhnimilana.ru/media-temp/files/Ричмонд__91pct_smaller.mp4',
      null, null, null, null, null, null, null, null, null, null, null, null, null,
    ],
    features: [
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0LSLx8yb5i198HrrA_hY4iv.jpg', icon: '◇', title: 'Klassisch und modern', text: 'Richmond verbindet klassische Proportionen mit modernen Materialien — ein Design, das nie veraltet.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0G650jVmIEfWeXz4E_J3ooX.jpg', icon: '▦', title: 'Email-Lackierung', text: 'Mehrschichtige Emaille-Beschichtung auf MDF: kratzfest, pflegeleicht und über Jahre hinweg wunderschön.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0XZTh7oEMuM9SShl8_2MsXh.jpg', icon: '▯', title: 'Weiss in all seinen Nuancen', text: 'Von reinem Weiss bis zartem Perlweiss — Richmond bietet Ihnen die perfekte Weissnuance für Ihren Raum.' },
      { img: 'https://kuhnimilana.ru/media-temp/img/goods/files_big/0rvO3qDHq57zOREaB_to7yd.jpg', icon: '◈', title: 'Schweizer Präzision', text: 'Massgenau gefertigt, millimetergenau montiert — für eine Küche, die einfach passt.' },
    ],
  },
}
